...
//'▲' : '▼';
    ...
    return (
        <section className="mail-actions">
            <label htmlFor="read">
                <select className="action-btn" id="read" htmlFor="read" name="read" onChange={onFilter}>
                    <option value="all">All</option>
                    <option value="read">Read</option>
                    <option value="unread">Unread</option>
                </select>
            </label>
            <button className="action-btn" onClick={() => handleSortChange('date')}> <span>{getArrow('date')}</span> Date
                {/* <span className="material-symbols-outlined">
                    expand_more
                </span> */}
            </button>
            <button className="action-btn" onClick={() => handleSortChange('subject')}><span>{getArrow('subject')}</span> Subject 
                {/* <span
